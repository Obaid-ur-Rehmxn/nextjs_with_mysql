export default function Home() {
  function submitForm(){
    ...
    xhttp.open("POST", '/api/insert?name='+name+"&email="+email+"&message="+message, true);
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full">
                  <button type="button" onClick={submitForm}
                          className="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Button
                  </button>
                </div>
              </div>
            </div>
